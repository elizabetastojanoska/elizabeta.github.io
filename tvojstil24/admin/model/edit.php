...
switch($table_name){
	...
	//$objNaracki=setRegTabli($reg_tabli);
	//$objNaracki=setKlientID($klient_id);
	$objNaracki->editNaracka();
	break;
	...
	$boja=$data[0]->boja;
	$vozac=$data[0]->vozac;
	$objVozilo->setVoziloID($pk_value);
