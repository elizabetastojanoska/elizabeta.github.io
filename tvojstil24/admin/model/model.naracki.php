...
class ModelNaracki extends DB{
	...
	public function editNaracka(){
		$columns = "naracka_datum='$this->naracka_datum',naracka_plaka='$this->naracka_plaka',vozilo_id=".$this->vozilo_id.",klient_id=$this->klient_id,proizvod_id=$this->proizvod_id,kolicina=$this->kolicina";
